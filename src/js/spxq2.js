...
//         var car11 = [
//             {
//                 img: "https://mall01.sogoucdn.com/image/2020/07/24/20200724105157_4902.png"
//                 , num: $('.count-input').val(), price: $('.count-input').val() * 399,
//                 mingcheng: $('.a1').text(), danjia: $('.qian').text()
//             }
//         ]
//         var car33 = JSON.stringify(car22);
//         localStorage.setItem('userCart22', car22)
...
//         // console.log(res)
//         // console.log($('.img_box'))
//         $('.img_box').html(`<img class="dzp_img" src='${res.b_img2[0]}' alt="">`)
...
//             let imgi = $(this).index();
//             $('.img_box').html(`<img class="dzp_img" src='${res.b_img2[imgi]}' alt="">`)
//         })
//     }
//     // 冒泡到小图片上加边框
//     $('.tupian>ul').on('mouseenter', 'li', function () {
...
$(function () {
    ...
    $('.s11').click(function () {
        ...
        var car22 = JSON.stringify(car11);
        localStorage.setItem('userCart22', car22)
