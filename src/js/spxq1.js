...
//         var car = [
//             {
//                 img: "https://mall03.sogoucdn.com/image/2020/07/06/20200706133353_4783.png"
//                 , num: $('.count-input').val(), price: $('.count-input').val() * 2698,
//                 mingcheng: $('.a1').text(), danjia: $('.qian').text()
//             }
//         ]
//         var car1 = JSON.stringify(car);
//         localStorage.setItem('userCart', car1)
...
//         // console.log(res)
//         // console.log($('.img_box'))
//         $('.img_box').html(`<img class="dzp_img" src='${res.b_img1[0]}' alt="">`)
...
//             let imgi = $(this).index();
//             $('.img_box').html(`<img class="dzp_img" src='${res.b_img1[imgi]}' alt="">`)
//         })
//     }
//     // 冒泡到小图片上加边框
//     $('.tupian>ul').on('mouseenter', 'li', function () {
...
$(function () {
        ...
        var car11 = [
            {
                ...
                , num: $('.count-input').val(), price: $('.count-input').val() * 799,
                mingcheng: $('.a1').text(), danjia: $('.qian').text()
            }
        ]
        var car11 = JSON.stringify(car11);
        localStorage.setItem('userCart11', car11)
    ...
    function eveneinit(res) {
        var i = 0;
        var str = ""
        for (i = 0; i < res.b_img.length; i++) {
            // console.log(res.b_img[i]);
            $('.ull').html(`<li class="xzp x zuiqian" index="1"><img class="xzp_img"
                                src="${res.b_img1[0]}" alt="">
                        </li>
                        <li class="xzp x" index="2"><img class="xzp_img"
...
$(".count-btn").click(function () {
    var n = $(this).siblings('.count-input').val()
    n++;
    $(this).siblings('.count-input').val(n);
});
$(".icon-detail-minus").click(function () {
    var n = $(this).siblings('.count-input').val()
    if (n == 1) {
        return false
    }
